...
static const char *upvol[] = { "wpctl", "set-volume", "-l", "1.5", "@DEFAULT_AUDIO_SINK", "1%+", NULL };
static const char *downvol[] = { "wpctl", "set-volume", "-l", "1.5", "@DEFAULT_AUDIO_SINK", "1%+", NULL };
static const char *mute[] = { "wpctl", "set-mute", "@DEFAULT_AUDIO_SINK@", "toggle", NULL };
static const char *micupvol[] = { "wpctl", "set-volume", "-l", "1.5", "@DEFAULT_AUDIO_SOURCE", "1%+", NULL };
static const char *micdownvol[] = { "wpctl", "set-volume", "-l", "1.5", "@DEFAULT_AUDIO_SOURCE", "1%+", NULL };
